...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .addFields({ name: 'Bot Sahibi', value: `UmutTuncel`, inline: false})
    ...
    .addFields({ name: '• İşletim Sistemi', value: `Windows 8 Pro 32 Bit`, inline: false})
    ...
    .addFields({ name: '• Bot Kuruluş', value: `25.11.2022`, inline: true})
